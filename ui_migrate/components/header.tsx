      ...
      <div className="ml-auto flex items-center gap-4">
        <DropdownMenu>
          ...
          >
            ...
            {[
              { title: "New client pairing request", desc: "IP: 192.168.1.45", time: "Just now" },
              { title: "Game installation complete", desc: "Elden Ring is ready to play", time: "10m ago" },
              { title: "System update available", desc: "Version 2.4.1 is ready to install", time: "1h ago" },
            ].map((notification, i) => (
              <DropdownMenuItem
                key={i}
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" size="icon" className="rounded-full">
              <Avatar>
                ...
                <AvatarFallback className="bg-[#0077B6] text-white">AD</AvatarFallback>
              </Avatar>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            align="end"
            className="w-56 bg-[rgba(0,0,0,0.8)] backdrop-blur-md border-[rgba(255,255,255,0.1)] text-white"
          >
            <DropdownMenuLabel>My Account</DropdownMenuLabel>
            <DropdownMenuSeparator className="bg-[rgba(255,255,255,0.1)]" />
            <DropdownMenuItem className="cursor-pointer hover:bg-[rgba(255,255,255,0.05)]">Profile</DropdownMenuItem>
            <DropdownMenuItem className="cursor-pointer hover:bg-[rgba(255,255,255,0.05)]">Settings</DropdownMenuItem>
            <DropdownMenuSeparator className="bg-[rgba(255,255,255,0.1)]" />
            <DropdownMenuItem className="cursor-pointer text-[#0077B6] hover:bg-[rgba(255,255,255,0.05)]">
              Logout
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
